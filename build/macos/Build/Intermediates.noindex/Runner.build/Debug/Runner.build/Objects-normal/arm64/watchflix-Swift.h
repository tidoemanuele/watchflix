...
#ifndef WATCHFLIX_SWIFT_H
#define WATCHFLIX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="watchflix",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9watchflix11AppDelegate")
...
SWIFT_CLASS("_TtC9watchflix17MainFlutterWindow")
